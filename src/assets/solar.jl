...
Create and initialize every data struct nested in the Solar structure 
"
...
Replace the Solar panel if needed for year y and scenario s. If the Solar panel is replaced a new size is affected.
" 
...
Replace the Solar panel if needed. If the Solar panel is replaced a new size is affected.
" 
