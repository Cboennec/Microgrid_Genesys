...
function initialize_population!(f::Function, lb, ub, method::Clearing, options::MetaResultOptions)
...
### Update population
function update_population!(f::Function, lb, ub, method::Clearing, options::MetaResultOptions)
...
### Assessment
function assessment!(f::Function, method::Clearing, options::MetaResultOptions)
    # Parameters
	n = size(method.population, 2) - 3
